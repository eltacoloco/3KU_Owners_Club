...
#define LASERPIN_5V  5
#define LEVEL_Z_OFFSET 0.15

// This enables the serial port associated to the Bluetooth interface
//#define BTENABLED              // Enable BT interface on AT90USB devices

//begin added by changkai for st188 end stop
//#define ST188FORZMIN 
//end 
...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "3KU Delta"
...
#define DELTA_DIAGONAL_ROD 228 // mm   //yang ji  268    // customer 271
...
//it is highly recommended you let this Z_SAFE_HOMING enabled!!!
  ...
  #define ACCURATE_BED_LEVELING
    ...
    #define ACCURATE_BED_LEVELING_POINTS 6
...
#define MANUAL_Z_HOME_POS 280 // For delta: Distance between nozzle and print surface after homing.195.5
...
#define DEFAULT_MAX_FEEDRATE          {150, 150, 150, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,1000,1200}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
