...
/*
 * This configuation file is made for the Delta Printer "3KU Delta printer" and
 * the Firmware "Marlin 1.1.0-RC7"
*/
...
//#define MANUAL_Z_HOME_POS 289.5 // Distance between the nozzle to printbed
  #define MANUAL_Z_HOME_POS 289.4 // Distance between the nozzle to printbed with tape
...
#define HOMING_FEEDRATE_Z  (2000) // NOTE
