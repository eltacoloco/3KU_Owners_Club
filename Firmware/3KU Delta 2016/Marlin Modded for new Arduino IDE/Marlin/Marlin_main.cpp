...
void process_commands()
{
  ...
  else if(code_seen('M'))
  {
    ...
    break;
#endif
     case 3: //M3 Open laser by kevin
         #if defined(LASERPIN_5V) && LASERPIN_5V > -1
             WRITE(LASERPIN_5V,HIGH);
         #endif
    break; 
    case 5://M5 close laser by kevin --3K
         #if defined(LASERPIN_5V) && LASERPIN_5V > -1
             WRITE(LASERPIN_5V,LOW);
         #endif
    break; 
...
// mc arc for delta machine --added by Kevin 3K Tech. Co.
